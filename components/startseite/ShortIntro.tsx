      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {saulen.map((s) => (
            ...
            >
              <div className="w-14 h-14 flex items-center justify-center rounded-lg text-on-secondary-container" style={{ background: "rgba(118, 244, 224, 0.35)" }}>
                {s.icon}
              </div>
              <h3 className="font-bold text-2xl text-primary" style={{ fontFamily: "var(--font-headline)" }}>
                {s.title}
              </h3>
